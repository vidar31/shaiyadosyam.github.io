  ...
  button.onmouseover = button.onfocus = function() {
    button.onclick = function() {
      ...
      window.iframeHandler = function () {
        var iframe = $_id('redirect-target');
        ...
        $_id('redirect-target').onload = null;
        $_id('redirect-target').src = 'about:blank';
...
function parseJson(data) {
  ...
  return eval('(' + data + ');'); // FIXME JAVASCRIPT_INJECT
}
...
function deleteIframe() {
  var holder = $_id('redirect-holder');
  if (holder != null) {
    removeNode(holder);
  }
}
